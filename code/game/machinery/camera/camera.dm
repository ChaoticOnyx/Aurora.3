		...
		for(var/mob/O in player_list)
			if (istype(O.machine, /obj/machinery/computer/security))
				...
				if (S.current_camera == src)
					...
					show_browser(O, text("<HTML><HEAD><TITLE>[]</TITLE></HEAD><BODY><TT>[]</TT></BODY></HTML>", itemname, info), text("window=[]", itemname)) //Force people watching to open the page so they can't see it again)
